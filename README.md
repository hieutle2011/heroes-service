...
organizations:
  Org1:
    mspid: org1.hf.leadiq.com
    cryptoPath: "peerOrganizations/org1.hf.leadiq.com/users/{userName}@org1.hf.leadiq.com/msp"
    peers:
      - peer0.org1.hf.leadiq.com
      - peer1.org1.hf.leadiq.com
...
orderers:
  orderer.hf.leadiq.com:
    ...
    grpcOptions:
      ssl-target-name-override: orderer.hf.leadiq.com
      grpc-max-send-message-length: 15
    tlsCACerts:
      path: "${GOPATH}/src/github.com/leadiq/heroes-service/network/crypto-config/ordererOrganizations/hf.leadiq.com/tlsca/tlsca.hf.leadiq.com-cert.pem"
...
peers:
  peer0.org1.hf.leadiq.com:
    ...
    grpcOptions:
      ssl-target-name-override: peer0.org1.hf.leadiq.com
      grpc.http2.keepalive_time: 15

    tlsCACerts:
      path: "${GOPATH}/src/github.com/leadiq/heroes-service/network/crypto-config/peerOrganizations/org1.hf.leadiq.com/tlsca/tlsca.org1.hf.leadiq.com-cert.pem"

  peer1.org1.hf.leadiq.com:
    url: grpcs://localhost:8051
    eventUrl: grpcs://localhost:8053
    grpcOptions:
      ssl-target-name-override: peer1.org1.hf.leadiq.com
      grpc.http2.keepalive_time: 15
    tlsCACerts:
